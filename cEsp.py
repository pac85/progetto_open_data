...
mat["region (public/private)"] = [x + " (" + y + ") " for x,y in zip(mat["region"], mat["type(public, private)"])]  #considerare la differenza tra pubblica e privata, la coppia (pubblica/privata, regione) diventa un solo attributo
